...
const fs                      = require('fs')
    ...
    , readLengthPrefixedSlice = require('./protobuf').readLengthPrefixedSlice
...
var Reader = (function () {
      ...
      Reader.prototype.readLengthPrefixedSlice = function(offset, fragment) {
        return fragment ?
          readLengthPrefixedSlice(this._combinedFragment, offset) :
          readLengthPrefixedSlice(this._buffer, this._position + offset)
      }
